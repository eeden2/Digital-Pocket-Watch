...
void ui_event_clock_group(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP) {
        ...
        _ui_screen_change(&ui_camera, LV_SCR_LOAD_ANIM_MOVE_TOP, 500, 0, &ui_camera_screen_init);
    }
}
void ui_event_dot17(lv_event_t * e)
{
...
void ui_event_bg_3(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_BOTTOM) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(&ui_watch_analog, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 500, 0, &ui_watch_analog_screen_init);
    }
}
void ui_event_dot2(lv_event_t * e)
{
